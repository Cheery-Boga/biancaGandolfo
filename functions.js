...
/** In this function segment assignment, we are going to take our filtered data and return it into an array of strings. **/
...
const suspectsNames = _.map(suspects, suspect => {return suspect.name;} )
