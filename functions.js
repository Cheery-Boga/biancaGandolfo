...
// We needed created a variable "suspects" to store the return value of that _.filter function, so that we can use it in our _.map function below:

const suspectsName = _.map(suspects, suspect => {return suspect.name;} )

/**  The last statement on line 93, returns the names of the suspects as strings, inside an array:
